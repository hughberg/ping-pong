...
(function(){
	self.Ball = function(x,y,radius,board){
		...
		this.direction = 1;
		this.bounce_angle = 0;
		this.max_bound_angle = Math.PI / 12;
		this.speed = 3;
	...
	//Método para que la pelota se mueva
	self.Ball.prototype = {
		move: function(){	
		...
		collision: function(bar){
			//Reacciona a la colision con una barra: ángulo, dirección...
			var relative_intersect_y = ( bar.y + (bar.height / 2) ) - this.y;
			var normalized_intersect_y = relative_intersect_y / (bar.height / 2);

			this.bounce_angle = normalized_intersect_y * this.max_bound_angle;
